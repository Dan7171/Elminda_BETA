...
def ci(X_test, y_test,model):
    ...
    for n in range(500):
        ...
        X_test_new = X_test.iloc[random_indices,:].drop(columns=['index'])
        y_test_new = y_test.iloc[random_indices,:].drop(columns=['index'])
