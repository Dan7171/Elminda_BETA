...
"scoring_method": 'f1', # "accuracy" /'f1'/ 'roc_auc'
...
"balance_y_values" : False, # working for clasification only. balancing the number of responsive and non responsive (y categories)

"n_iter": 50, # param for randomized cv - num of combinations to try in randomized search
